...
const Servers = () => {
  ...
  const serverlist = [
    {id: 1, rank:5, name:<a href="#server1-link">appesolife</a>, players:82, modalita:"RPG", join:<a href="#server1" ><FontAwesomeIcon size="lg" icon={['fas', 'sign-in-alt']} /></a>},
    ...
    {id: 4, rank:1, name:<a href="#server4-link">lesslife</a>, players:5, modalita:"RPG", join:<a href="#server4" ><FontAwesomeIcon size="lg" icon={['fas', 'sign-in-alt']} /></a>},
    {id: 5, rank:4, name:<a href="#server5-link">octa mrp</a>, players:9, modalita:"CTF", join:<a href="#server5" ><FontAwesomeIcon size="lg" icon={['fas', 'sign-in-alt']} /></a>},
    ...
    {id: 7, rank:3, name:<a href="#server7-link">tumplife</a>, players:14, modalita:"RPG", join:<a href="#server7" ><FontAwesomeIcon size="lg" icon={['fas', 'sign-in-alt']} /></a>},
  ];
